  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-transparent  border-white/5">
      <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* --- Center Glass Nav --- */}
        <div className="hidden md:flex items-center justify-center gap-30 text-2xl px-2 py-2  rounded-xl w-200  backdrop-blur-md border border-white/25 shadow-[0_4px_8px_rgba(255,255,255,0.08)]">
          <button
